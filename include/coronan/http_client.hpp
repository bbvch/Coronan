...
class HTTPResponse {
 public:   
    explicit HTTPResponse(Poco::Net::HTTPResponse const & response, std::string const & response_str) 
        : response_{response}
...
template<typename SessionT = Poco::Net::HTTPClientSession, typename HTTPRequestT = Poco::Net::HTTPRequest>
struct HTTPClient
{
